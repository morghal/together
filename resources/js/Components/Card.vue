                  ...
                  <div class="relative shadow-lg shadow-slate-700/50 min-w-[225px] ml-6 mr-3 rounded-xl pb-5 bg-[#4B8798] " width="225">
                    ...
                    <div class="px-6 py-4">
                      ...
                      <p class="text-slate-50 text-base mb-2">
                        ...
                        </svg> <span class="pr-2">{{ item.user }}</span>

                        <!--5 étoiles-->
                        <div><svg fill="currentColor" v-for="(star, index) in 5" :key="index" :class="index < item.rating ? 'text-gargoylegas' : 'text-slate-50'" class="inline align-text-top h-4 w-4" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                      ...
                      <p class="text-slate-50 text-base mb-2">
                          ...
                          </svg> <span class="">{{item.nbr_participants + "/" + item.max_participants + " participants" }}</span>
